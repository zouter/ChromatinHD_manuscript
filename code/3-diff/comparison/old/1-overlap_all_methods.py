...
panel_main = grid[0, 0] = polyptich.grid.Panel(dim)
ax = panel_main.ax
...
panel_jaccard = grid_cbars[0, 0] = polyptich.grid.Panel((1, 0.1))
ax = panel_jaccard.ax
cax = plt.colorbar(
...
panel_jaccard = grid_cbars[1, 0] = polyptich.grid.Panel((1, 0.1))
ax = panel_jaccard.ax
cax = plt.colorbar(
