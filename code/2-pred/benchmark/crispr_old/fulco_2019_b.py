...
# %%
data = data.loc[data["Gene"] != "JUNB"].copy() # !!! not differential
...
IPython.display.HTML(genescores.to_html(index = False, col_space = 100))
...
plotdata = methodscores.loc[(methodscores["w"] == 30) | (methodscores["method"] == "all")].copy()
