...
import chromatinhd.models.promotermotif.v4.actual
import chromatinhd.models.promotermotif.v4.actual
import chromatinhd.models.promotermotif.v4.baseline
...
def get_design(dataset_name, transcriptome, motifscan, fragments, window):
    ...
    design = {}
    design["v4_baseline"] = {
        "model_cls": chromatinhd.models.promotermotif.v4.baseline.Model,
    ...
    baseline_location = chd.get_git_root() / (dataset_name + "_" + "baseline_model.pkl")
    if baseline_location.exists():
        baseline_model = pickle.load(open(baseline_location, "rb"))
    else:
        baseline_model = None
    design["v4_dummy"] = {
        "model_cls": chromatinhd.models.promotermotif.v4.actual.Model,
        "model_parameters": {
            **general_model_parameters,
            "baseline": baseline_model,
            "dummy_motifs": True,
        },
        "loader_cls": chromatinhd.loaders.fragmentmotif.Motifcounts,
        "loader_parameters": {
            **general_loader_parameters,
    ...
    design["v4_split"] = {
        "model_cls": chromatinhd.models.promotermotif.v4.actual.Model,
        "model_parameters": {**general_model_parameters, "baseline": baseline_model},
        "loader_cls": chromatinhd.loaders.fragmentmotif.MotifcountsSplit,
        "loader_parameters": {
            **general_loader_parameters,
            "cutwindow": np.array([-150, 150]),
        },
    ...
    design["v4_150-100-50-0"] = {
        "model_cls": chromatinhd.models.promotermotif.v4.actual.Model,
        "model_parameters": {**general_model_parameters, "baseline": baseline_model},
        "loader_cls": chromatinhd.loaders.fragmentmotif.MotifcountsMultiple,
        "loader_parameters": {
            **general_loader_parameters,
            "cutwindows": np.array([-150, -100, -50, 0]),
        },
    }
    ...
    design["v4_1k-150-0_nn"] = {
        ...
        "loader_parameters": {
            **general_loader_parameters,
            "cutwindows": np.array([-1000, -150, 0]),
        },
    }
    ...
    design["v4_prom"] = {
        "model_cls": chromatinhd.models.promotermotif.v4.actual.Model,
        "model_parameters": {**general_model_parameters, "baseline": baseline_model},
        "loader_cls": chromatinhd.loaders.fragmentmotif.MotifcountsRelative,
        "loader_parameters": {
            **general_loader_parameters,
            "cutwindow": np.array([-150, 150]),
            "promoter_width": 500,
...
def get_folds_inference(fragments, folds):
    for fold in folds:
        ...
        minibatches_train = chd.loaders.minibatching.create_bins_ordered(
            cells_train,
            genes_train,
            n_cells_step=n_cells_step,
            n_genes_step=n_genes_step,
        ...
        minibatches_validation = chd.loaders.minibatching.create_bins_ordered(
        ...
        minibatches_validation_cell = chd.loaders.minibatching.create_bins_ordered(
            cells_validation,
            genes_train,
            n_cells_step=n_cells_step,
            n_genes_step=n_genes_step,
...
def get_folds_test(fragments, folds):
    for fold in folds:
        ...
        minibatches_test = chd.loaders.minibatching.create_bins_ordered(
            cells_test,
            genes_test,
            n_cells_step=n_cells_step,
            n_genes_step=n_genes_step,
        ...
        minibatches_test_cells = chd.loaders.minibatching.create_bins_ordered(
            cells_test,
            genes_train,
            n_cells_step=n_cells_step,
            n_genes_step=n_genes_step,
