...
# %%
prediction_name = "v20"; splitter_name = "random_5fold"
prediction_name = "v20_initdefault"; splitter_name = "random_5fold"

# %%
prediction = Prediction(chd.get_output() / "prediction_positional" / dataset_name / promoter_name / splitter_name / prediction_name)

# %%
# scores_dir = (prediction.path / "scoring" / ("windows" + "_1000"))
...
peaks_bed = pybedtools.BedTool(chd.get_output() / "peaks" / dataset_name / "macs2" / "peaks.bed")
...
ax_title_ = fig.main.add(chd.grid.Title(transcriptome.symbol(gene_id) + " promoter", dim = (w, 0.8)))
...
IPython.display.HTML("<textarea>" + chd.utils.name_window(promoters.loc[gene_id]) + "</textarea>")
