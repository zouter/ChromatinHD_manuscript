...
# motifscan
motifscan = chd.data.Motifscan(chd.get_output() / "motifscans" / dataset_name_train / promoter_name)
...
for prediction_name, design_row in design.items():
    ...
    prediction_train = Prediction(
        chd.get_output() / "prediction_sequence" / dataset_name_train / promoter_name / prediction_name
    )
    prediction = chd.flow.Flow(
        chd.get_output() / "prediction_sequence" / dataset_name / promoter_name / prediction_name
    )
